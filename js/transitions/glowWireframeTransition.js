...
function finishTransition() {
  ...
  document.getElementById('effect-wireframe-btn').classList.toggle('active', true);
...
function setTransitionButtonBusy(busy) {
  const btn = document.getElementById('effect-glow-wire-toggle-btn');
...
export function setupGlowWireTransitionUI() {
  document.getElementById('effect-glow-wire-toggle-btn').addEventListener('click', () => {
